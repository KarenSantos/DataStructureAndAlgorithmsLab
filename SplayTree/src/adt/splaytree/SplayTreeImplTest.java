...
public class SplayTreeImplTest {
	...
	private SplayTreeImpl<Integer> tree1;
	private SplayTreeImpl<Integer> tree2;
	private SplayTreeImpl<Integer> tree3;

	@Before
	public void setUp() throws Exception {
		// Somente filhos a esquerda
		tree1 = new SplayTreeImpl<Integer>();
		for (int i = 0; i < SIZE; i++) {
			tree1.insert(i);
		}

		// Somente filhos a direita
		tree2 = new SplayTreeImpl<Integer>();
		for (int i = SIZE - 1; i >= 0; i--) {
			tree2.insert(i);
		}

		// arvore vazia
		tree3 = new SplayTreeImpl<Integer>();
	}
