...
public class GnomeTest {
	...
	Gnomesort<Integer> sort;
	Gnomesort<String> sortString;

	@Before
	public void antes() {
		sort = new Gnomesort<Integer>();
		sortString = new Gnomesort<String>();
	}

	@Test
	public void testPiorCaso() {
		Integer[] atual = {05,04,03,02,01};
	...
	@Test
	public void testIndiceAcima() {
		Integer[] atual = {100,10};
		Integer[] esperado = {100,10};

		sort.sort(atual, 0, 10);

		Assert.assertArrayEquals(esperado, atual);
	}
	
	@Test
	public void testIndiceInverso() {
		Integer[] atual = {100,10};
		Integer[] esperado = {100,10};
