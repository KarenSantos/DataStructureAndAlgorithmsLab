...
public class StackDoubleLinkedListImplTest {
	...
	StackDoubleLinkedListImpl<Integer> stackInt;
	StackDoubleLinkedListImpl<String> stackString;
	
	@Before
	public void antes(){
		stackInt = new StackDoubleLinkedListImpl<Integer>(5);
		stackString = new StackDoubleLinkedListImpl<String>(4);
	}
